...
inline static constexpr std::array s_Patterns = {
    ...
    Pattern{0x08aa1974, "? ? ? ? 25 20 00 02 25 98 40 00 ? ? 72 12"},
    Pattern{0x08aa1a00, "? ? ? ? 04 00 b3 a0 25 98 40 00"},
    Pattern{0x088a4ac4, "16 01 05 34 ? ? 85 10 00 00 13 34 ? ? ? ?"},
    Pattern{0x08bb380c, "? ? ? ? 50 00 c5 8f 00 00 e6 8e ? ? ? ? be 00 07 34 25 20 40 00", 0, Pattern::GPOFFSET},
    Pattern{0x088e2798, "f0 ff bd 27 ? ? ? ? ? ? ? ? 25 88 80 00 ? ? ? ? ? ? ? ? ? ? c0 14 25 80 a0 00 ? ? ? ? 00 00 00 00 0c 00 24 8e"},
    Pattern{0x08abe9ac, "? ? ? ? 25 20 00 02 25 80 40 00 25 10 00 02"},
    Pattern{0x08bb3f2c, "? ? ? ? 2b 20 44 00 ? ? 80 14 00 00 00 00 ? ? ? ? 25 20 00 02", 0, Pattern::GPOFFSET},
    Pattern{0x08a4ea10, "01 00 09 34 01 00 02 34 01 00 0a 34 01 00 0b 34 ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? 40 10 80 00 04 3c"},
    Pattern{0x0893fa90, "? ? 85 14 00 00 00 00 ? ? ? ? 20 00 05 3c 24 20 85 00 ? ? 80 14"},
    Pattern{0x008bada10, "? ? ? ? 96 44 05 3c 00 70 85 44", 0, Pattern::GPOFFSET},
    #ifdef ENABLE_DEBUG_MENU
    Pattern{0x089364b4, "? ? ? ? 00 00 00 00 ? ? ? ? 00 00 00 00 ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? 08 00 e0 03 50 00 bd 27"},
    Pattern{0x0898b794, "? ? ? ? 25 28 00 00 ? ? ? ? 01 00 04 34 ? ? ? ? 02 00 44 24"},
    #endif
};
